...
const PRESETS: ProviderPreset[] = [
  ...
  {
    providerId: "qq-exmail",
    providerName: "Tencent Exmail",
    domains: ["exmail.qq.com"],
    authType: "password",
    incoming: { host: "imap.exmail.qq.com", port: 993, secure: true },
    outgoing: { host: "smtp.exmail.qq.com", port: 465, secure: true },
    helpText: "Use the enterprise mailbox authorization code when available.",
  },
  {
  ...
  {
    providerId: "netease-vip-163",
    providerName: "NetEase VIP 163",
    domains: ["vip.163.com"],
    authType: "password",
    incoming: { host: "imap.vip.163.com", port: 993, secure: true },
    outgoing: { host: "smtp.vip.163.com", port: 465, secure: true },
    helpText: "Use a mailbox authorization code instead of the login password.",
  },
  {
  ...
  {
    providerId: "netease-vip-126",
    providerName: "NetEase VIP 126",
    domains: ["vip.126.com"],
    authType: "password",
    incoming: { host: "imap.vip.126.com", port: 993, secure: true },
    outgoing: { host: "smtp.vip.126.com", port: 465, secure: true },
    helpText: "Use a mailbox authorization code instead of the login password.",
  },
  {
    providerId: "netease-188",
    providerName: "NetEase 188",
    domains: ["188.com"],
    authType: "password",
    incoming: { host: "imap.188.com", port: 993, secure: true },
    outgoing: { host: "smtp.188.com", port: 465, secure: true },
    helpText: "Use a mailbox authorization code instead of the login password.",
  },
  {
    providerId: "netease-vip-188",
    providerName: "NetEase VIP 188",
    domains: ["vip.188.com"],
    authType: "password",
    incoming: { host: "imap.vip.188.com", port: 993, secure: true },
    outgoing: { host: "smtp.vip.188.com", port: 465, secure: true },
    helpText: "Use a mailbox authorization code instead of the login password.",
  },
  {
