    ...
    <section className="report-shell emergency-shell">
      <aside className="report-sidebar emergency-sidebar">
        <div className="report-sidebar-head">
          ...
          <h2>全本预案生成</h2>
          <p>导入 PDF/Word 模板并补充项目要求后，自动生成完整的 Word 版应急预案。</p>
        </div>
        ...
        <div className="report-sidebar-card">
          ...
          {form.templateFiles.length > 0 ? (
            ...
            <div className="thread-section-empty">先导入 1 份或多份历史预案模板，系统会自动识别正文结构。</div>
          )}
        </div>
        ...
        <div className="report-hero">
          <div className="report-hero-card">
            ...
            <div className="report-hero-copy">
              ...
              <span>模板越贴近行业和地区场景，生成出来的预案越稳定。</span>
            </div>
          </div>
          <div className="report-hero-card">
            <div className="report-hero-icon">
        ...
        <div className="report-panel">
          {result ? (
            ...
            <div className="report-empty">
              ...
              <span>系统会先识别模板正文，再结合你的项目参数生成一份完整的应急预案全本。</span>
            </div>
          )}
        </div>
      </div>
